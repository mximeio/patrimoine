...
const VERSION = '?v=570'.replace('?v=', 'v'); // réécrit par le sed de bump
...
const APP_SHELL = [
  ...
  'styles.css?v=570',
  'manifest.json?v=570',
  'manifest-dev.json?v=570',
  'apple-touch-icon.png?v=570',
  'icon-192.png',
  'icon-512.png',
  ...
  'js/backups.js?v=570',
  'js/checking.js?v=570',
  'js/savings.js?v=570',
  'js/physical.js?v=570',
  'js/investments.js?v=570',
  'js/consolidated.js?v=570',
  'js/search.js?v=570',
  'js/charges.js?v=570',
  'js/app.js?v=570',
];
