...
const VERSION = '?v=612'.replace('?v=', 'v'); // réécrit par le sed de bump
...
const APP_SHELL = [
  ...
  'styles.css?v=612',
  'manifest.json?v=612',
  'manifest-dev.json?v=612',
  'apple-touch-icon.png?v=612',
  'icon-192.png',
  'icon-512.png',
  ...
  'js/backups.js?v=612',
  'js/checking.js?v=612',
  'js/savings.js?v=612',
  'js/physical.js?v=612',
  'js/investments.js?v=612',
  'js/consolidated.js?v=612',
  'js/search.js?v=612',
  'js/charges.js?v=612',
  'js/app.js?v=612',
];
